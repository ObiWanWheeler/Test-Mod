...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> MATSURIBLOCK_BLOCK = BLOCKS.register("matsuri_block",
    ...
    public static final RegistryObject<Block> POOBLOCK_BLOCK = BLOCKS.register("poo_block",
            () -> new Block(AbstractBlock.Properties.create(Material.ROCK, MaterialColor.BROWN)
                    .harvestTool(ToolType.SHOVEL).hardnessAndResistance(1.5f, 6.0f).sound(SoundType.SLIME)));
}
